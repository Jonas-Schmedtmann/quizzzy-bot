...
module.exports = class AddCommand extends Commando.Command {
  ...
  async run(message) {
    const rules = [
      ...
      "At the end of Day 7, we will release our solution along with some of the featured solutions given by you all. *(Note: Your code does not have to be the same as the one we will provide)*. Along with the solution, we will also post the next challenge question.",
